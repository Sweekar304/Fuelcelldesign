...
plot([0 Distance],[0;(Current(:,1)/Acell)]/1000)
plot([0 Distance],[0;(power(:,1)/Acell)]/1000)
plot([0 Distance(1:end-1)],[0;(-HeatTransfer(:,1)/Acell)]/1000)
...
plot(Distance,xH2(:,1))
plot(Distance,xO2(:,1))
plot(Distance,xH2O(:,1))
plot(Distance,pot_diff_eq(:,1))
