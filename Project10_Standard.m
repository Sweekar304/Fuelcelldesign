...
plot([0 Distance],[0;(Current(:,62)/Acell)]/1000)
plot([0 Distance],[0;(power(:,62)/Acell)]/1000)
plot([0 Distance(1:end-1)],[0;(-HeatTransfer(:,62)/Acell)]/1000)
...
hold on
Distance = L*(1:1:Cellnum)/Cellnum;
plot(Distance,xH2(:,62))
plot(Distance,xO2(:,62))
plot(Distance,xH2O(:,62))
plot(Distance,pot_diff_eq(:,62))
plot([0 0.5],[0.62 0.62],'--k')
